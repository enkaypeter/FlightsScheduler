...
<form method="POST" action="/company/register-staff">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-6">
          <select name="origin"  id="origin" onchange="getOrigin()" class="form-control">
            ...
            <option  value="{{$airports->Airport}},+{{$airports->City}},+Airport">{{$airports->City}} ({{$airports->Airport}})</option>
            @endforeach
          </select>
        </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-6">
			<input class="form-control calendar" data-enable-time="true" data-time_24hr="true">
        </div>
      </div>
