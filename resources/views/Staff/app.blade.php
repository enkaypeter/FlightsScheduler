      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            <li><a href="/staff"> <i class="icon-home"></i>Home</a></li>
            <li><a href="/staff/staff-info"> <i class="icon-form"></i>View your Schedule                           </a></li>
          </ul>
        </div>
      </div>
    </nav>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="index.html" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block"><span>Flight Scheduler </span><strong class="text-primary">Staff Dashboard</strong></div></a></div>
